                  ...
                  <div className="flex gap-3 w-full md:w-auto">
                    <div className="relative flex-1 md:w-64">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-medium/20 focus:border-medium"
                      />
                    </div>
                    <select
                      value={filterStatus}
                        ...
                        <button
                          onClick={() => {
                            ...
                            addRequest({
                              ...
                              from: "Sistema",
                              message: `Você aceitou ${request.patientName} como paciente.`,
                              priority: "low",
                              autoClose: true
                            });
                          }}
                        ...
                        <button 
                          onClick={() => {
                            ...
                            addRequest({
                              ...
                              from: "Sistema",
                              message: `Você rejeitou a solicitação de ${request.patientName}.`,
                              priority: "low",
                              autoClose: true
                            });
                          }}
